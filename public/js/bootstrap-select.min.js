...
!function($) {
    ...
    Selectpicker.prototype = {
        ...
        init: function() {
            ...
            this.$element.before(this.$newElement);  //XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
        ...
        createDropdown: function() {
            ...
            var drop =
                "<div class='btn-group bootstrap-select" + multiple + "'>" +
                    "<button type='button' class='btn dropdown-toggle' data-toggle='dropdown' id='button"+ this.$element.attr("name") +"'>" +
        ...
        createLi: function() {
            ...
            this.$element.find('option').each(function() {
                ...
                var title_op = $this.attr("title") || '';
                
                _title.push(title_op);
            ...
            $.each(_liA, function(i, item) {
                _liHtml += "<li title='"+ _title[i] +"' rel=" + i + ">" + item + "</li>";
            });
        ...
        render: function() {
            ...
            var selectedItems = this.$element.find('option:selected').map(function() {
                ...
                if ($this.data('content') && that.options.showContent) {
                    ...
                    //return $this.attr('title'); cleiver
        ...
        clickListener: function() {
            ...
            this.$menu.on('click', 'li a', function(e) {
                var clickedIndex = $(this).parent().index(),
                    ...
                    /* CÓDIGO QUE SE EJECUTA CUANDO SE SELECCIONA UNA OPCIÓN DEL COMBO Y QUITA EL MENSAJE DE ERROR
                     * Y LOS STYLE UNA VEZ QUE SE HACE CLIC
                     */
                    $("#button" + that.$element.attr("name")).removeClass("error");  // QUITA LA CLASE ERROR AL BUTTON PARA EVITAR EL BORDE ROJO
                    $("#" + that.$element.attr("name")).css("display", "none");      // aPLICA STYLO DISPLY NONE PARA EVTAR QUE EL ELEMENTO SE MUESTRE
