...
TableTools.BUTTONS = {
	...
	"xls": $.extend( {}, TableTools.buttonBase, {
		...
		"sCharSet": "utf16le",
		"bBomInc": true,
		"sToolTip": "Generar Excel",
		"sButtonClass": "DTTT_button_xls",
		"sButtonText": "<i class='fa fa-file-excel-o'></i>",
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
			this.fnInfo( "<h2>Generando Excel</h2><p><i class='fa fa-spinner fa-4x fa-spin'></i></p>",1500);
		}
	} ),
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Tabla Copiada</h6>'+
				'<p>Copio '+lines+' fila'+plural+' en el portapapeles.</p>',
				1500
			);
		}
	} ),
	...
	"pdf": $.extend( {}, TableTools.buttonBase, {
		...
		"fnClick": function( nButton, oConfig, flash ) {
			...
			this.fnInfo( "<h2>Generando PDF</h2><p><i class='fa fa-spinner fa-4x fa-spin'></i></p>",1500);
		}
	} ),

	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h2>Vista de impresión</h2><p>Por favor, utilice la función de impresión de su navegador para "+
		  "imprimir. Presione escape (Esc) cuando termine.</p>",
		"sMessage": null,
		"bShowAll": true,
 ...
 */
TableTools.DEFAULTS = {
	"sSwfPath":        BASE.url+"public/js/ZeroClipboard/copy_csv_xls_pdf.swf",
	"sRowSelect":      "none",
	"sRowSelector":    "tr",
	"sSelectedClass":  null,
	"fnPreRowSelect":  null,
