...
<head>
  <meta charset="utf-8">
  <title>Alzati Shoes</title>
  <meta name="keywords" content="Tienda Online Alzati Shoes">
  <meta name="description" content="Tienda Online Alzati Shoes">
  <meta name="author" content="Alzati Shoes">
  <link rel="shortcut icon" href="favicon.ico">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <link rel="stylesheet" href="<?php echo BASE_URL ?>public/css/theme.css">
  <link rel="stylesheet" href="<?php echo BASE_URL ?>public/js/toastr/toastr.css">
...
<!-- <div class="tt-promo-fixed">
  ...
  <div class="tt-img">
    <a href="product.html"><img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/product/product-14.jpg" alt=""></a>
  </div>
...
<header>
  ...
  <nav class="panel-menu mobile-main-menu">
    <ul>
      ...
      <li>
        <a href="listing-left-column.html">MUJERES</a>
        <ul>
          <li>
      ...
      <li>
        <a href="listing-right-column.html">HOMBRES</a>
        <ul>
          <li>
    ...
    <div class="container-fluid tt-top-line">
      <div class="row">
        <div class="tt-logo-container">
          <!-- mobile logo -->
          <a class="tt-logo tt-logo-alignment" href="index.html"><img src="<?php echo BASE_URL ?>public/images/custom/logo.png" alt=""></a>
          <!-- /mobile logo -->
        </div>
      </div>
    </div>
                        ...
                        <div class="col">
                          ...
                          <ul class="tt-megamenu-submenu">
                            <li><a href="index.html">Home — Example 1
                              <img src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 1">
                              <span class="tt-badge tt-fatured">Popular</span>
                            </a></li>
                            <li><a href="index-02.html">Home — Example 2 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 2"></a></li>
                            <li><a href="index-03.html">Home — Example 3 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 3"></a></li>
                            <li><a href="index-04.html">Home — Example 4
                              <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 4">
                              <span class="tt-badge tt-fatured">Popular</span>
                            </a></li>
                            <li><a href="index-05.html">Home — Example 5 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 5"></a></li>
                            <li><a href="index-06.html">Home — Example 6 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 6"></a></li>
                            <li><a href="index-07.html">Home — Example 7 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 7"></a></li>
                            <li><a href="index-08.html">Home — Example 8 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 8"></a></li>
                            <li><a href="index-09.html">Home — Example 9 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 9"></a></li>
                          </ul>
                        </div>
                        <div class="col">
                          <h6 class="tt-title-submenu"><a href="index.html">HOME STYLES</a></h6>
                          <ul class="tt-megamenu-submenu">
                            <li><a href="index-10.html">Home — Example 10 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 10"></a></li>
                            <li><a href="index-11.html">Home — Example 11 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 11"></a></li>
                            <li><a href="index-12.html">Home — Example 12 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 12"></a></li>
                            <li><a href="index-13.html">Home — Example 13 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 13"></a></li>
                            <li><a href="index-14.html">Home — Example 14 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 14"></a></li>
                            <li><a href="index-15.html">Home — Example 15 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 15"></a></li>
                            <li><a href="index-16.html">Home — Example 16
                              <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 16">
                              <span class="tt-badge tt-fatured">Popular</span>
                            </a></li>
                            <li><a href="index-17.html">Home — Example 17 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 17"></a></li>
                            <li><a href="index-18.html">Home — Example 18 <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-layout-img-01.png" alt="Example 18"></a></li>
                          </ul>
                        </div>
                        <div class="col">
                          ...
                          <ul class="tt-megamenu-submenu">
                            <li><a href="index-skin-snowboards.html">Snowboards Shop
                              <img src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-skins-img-01.png" alt="Snowboards Shop">
                              <span class="tt-badge tt-fatured">Popular</span>
                            </a></li>
                            <li><a href="index-skin-phones.html">Phones Shop
                              <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-skins-img-01.png" alt="Phones Shop">
                              <span class="tt-badge tt-fatured">Popular</span>
                            </a></li>
                            <li><a href="index-skin-bikes.html">Bikes Shop
                              <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-skins-img-01.png" alt="Bikes Shop">
                              <span class="tt-badge tt-fatured">Popular</span>
                            </a></li>
                            <li><a href="index-skin-lingerie.html">Lingerie Shop <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-skins-img-01.png" alt="Lingerie Shop"></a></li>
                            <li><a href="index-skin-furniture.html">Furniture Shop <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-skins-img-01.png" alt="Furniture Shop"></a></li>
                            <li><a href="index-skin-books.html">Books shop
                              <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/tt-skins-img-01.png" alt="Books Shop">
                          ...
                          <div class="row tt-col-list">
                            ...
                            <div class="col-sm-3">
                              ...
                              <ul class="tt-listing-01">
                                <li><a href="#" target="_blank"><img src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/brand-img-01.png" alt=""></a></li>
                                <li><a href="#" target="_blank"><img src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/brand-img-02.png" alt=""></a></li>
                                <li><a href="#" target="_blank"><img src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/brand-img-03.png" alt=""></a></li>
                                <li><a href="#" target="_blank"><img src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/brand-img-04.png" alt=""></a></li>
                                <li><a href="#" target="_blank"><img src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/brand-img-05.png" alt=""></a></li>
                                <li><a href="#" target="_blank"><img src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/brand-img-06.png" alt=""></a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="tt-menu-slider header-menu-product arrow-location-03 row">
                              ...
                              <div class="tt-product thumbprod-center">
                                <a href="product.html">
                                  <div class="tt-image-box">
                                    <span class="tt-img"><img src="<?php echo BASE_URL ?>public/images/product/product-01.jpg" alt=""></span>
                                    <span class="tt-img-roll-over"><img src="<?php echo BASE_URL ?>public/images/product/product-01-02.jpg" alt=""></span>
                                  </div>
                                  <div class="tt-description">
                            ...
                            <div class="col-2">
                              <div class="tt-product thumbprod-center">
                                <a href="product.html">
                                  <div class="tt-image-box">
                                    <span class="tt-img"><img src="<?php echo BASE_URL ?>public/images/product/product-02.jpg" alt=""></span>
                                    <span class="tt-img-roll-over"><img src="<?php echo BASE_URL ?>public/images/product/product-02-02.jpg" alt=""></span>
                                  </div>
                                  <div class="tt-description">
                                    <h2 class="tt-title">Flared Shift Dress</h2>
                                    <div class="tt-price">
                            ...
                            <div class="col-2">
                              <div class="tt-product thumbprod-center">
                                <a href="product.html">
                                  <div class="tt-image-box">
                                    <span class="tt-img"><img src="<?php echo BASE_URL ?>public/images/product/product-04.jpg" alt=""></span>
                                    <span class="tt-img-roll-over"><img src="<?php echo BASE_URL ?>public/images/product/product-04-01.jpg" alt=""></span>
                                  </div>
                                  <div class="tt-description">
                                    <h2 class="tt-title">Flared Shift Dress</h2>
                                    <div class="tt-price">
                            ...
                            <div class="col-2">
                              <div class="tt-product thumbprod-center">
                                <a href="product.html">
                                  <div class="tt-image-box">
                                    <span class="tt-img"><img src="<?php echo BASE_URL ?>public/images/product/product-05.jpg" alt=""></span>
                                    <span class="tt-img-roll-over"><img src="<?php echo BASE_URL ?>public/images/product/product-05-02.jpg" alt=""></span>
                                  </div>
                                  <div class="tt-description">
                                    <h2 class="tt-title">Flared Shift Dress</h2>
                                    <div class="tt-price">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <a href="listing-left-column.html" class="tt-promo-02">
                            <img src="<?php echo BASE_URL ?>public/images/custom/header-promo-01.jpg" alt="">
                        ...
                        <div class="col-sm-6">
                          <a href="listing-left-column.html" class="tt-promo-02">
                            <img src="<?php echo BASE_URL ?>public/images/custom/header-promo-02.jpg" alt="">
                            <div class="tt-description tt-point-h-l">
                              <div class="tt-description-wrapper">
                      ...
                      <div class="row">
                          ...
                          <div class="row tt-col-list">
                            <div class="col-sm-4">
                              <a href="listing-right-column.html" class="tt-title-submenu">
                                TOPS
                                <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/header-category-01.jpg" alt="">
                              </a>
                              <ul class="tt-megamenu-submenu">
                            ...
                            <div class="col-sm-4">
                              <a class="tt-title-submenu" href="listing-right-column.html">
                                BOTTOMS
                                <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/header-category-02.jpg" alt="">
                              </a>
                              <ul class="tt-megamenu-submenu">
                                <li><a href="listing-right-column.html">Trousers <span class="tt-badge tt-fatured">Fatured</span></a></li>
                                <li><a href="listing-right-column.html">Jeans</a></li>
                            ...
                            <div class="col-sm-4">
                              <a class="tt-title-submenu" href="listing-right-column.html">
                                ACCESSORIES
                                <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/header-category-03.jpg" alt="">
                              </a>
                              <ul class="tt-megamenu-submenu">
                                <li><a href="listing-right-column.html">Hats</a></li>
                                <li><a href="listing-right-column.html">Scarves &amp; Snoods</a></li>
                        ...
                        <div class="col-sm-3">
                          <div class="tt-offset-7">
                            <a href="listing-left-column.html" class="tt-promo-02">
                              <img  src="<?php echo BASE_URL ?>public/images/loader.svg" data-src="<?php echo BASE_URL ?>public/images/custom/header-promo-03.jpg" alt="">
        ...
        <div class="tt-col-obj tt-obj-options obj-move-right">
          ...
          <div class="tt-desctop-parent-multi tt-parent-box">
            <div class="tt-multi-obj tt-dropdown-obj">
              <button class="tt-dropdown-toggle" data-tooltip="Configuraci&oacute;n" data-tposition="bottom"><i class="icon-f-79"></i></button>
              <div class="tt-dropdown-menu">
                <div class="tt-mobile-add">
                ...
                <div class="tt-dropdown-inner">
                  <ul>
                    <li class="active"><a href="#">Ingles</a></li>
                  ...
                  <ul>
                    ...
                    <li><a href="#"><i class="icon-h-59"></i>CO - Peso Colombiano</a></li>
